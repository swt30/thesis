...
$else$
\hypersetup{colorlinks,allcolors=DarkRed}
$endif$
...
\setlength{\oddsidemargin}{0cm} % odd pages are okay already
\setlength{\evensidemargin}{-0.5cm} % even pages need more inner space
...
% r.5 dedication page (if present)
$if(dedication)$
  \cleardoublepage
  \thispagestyle{empty}
  \null\vfill
